...
class Create_users_session
{
	public function up()
	{
		\DBUtil::create_table('users_session', array(
		...
		\DB::query('CREATE INDEX oauth_sessions_ibfk_1 ON users_session(`client_id`)')->execute();
	}

	public function down()
	{
		\DB::query('DROP INDEX oauth_sessions_ibfk_1 ON users_session')->execute();

		\DBUtil::drop_table('users_session');
	}
}
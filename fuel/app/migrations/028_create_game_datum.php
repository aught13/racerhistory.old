...
class Create_game_datum
{
	public function up()
	{
		\DBUtil::create_table('game_datum', array(
		...
		\DB::query('CREATE INDEX game_id ON game_datum(`game_id`)')->execute();
	}

	public function down()
	{
		\DB::query('DROP INDEX game_id ON game_datum')->execute();

		\DBUtil::drop_table('game_datum');
	}
}
...
class Create_games
{
	public function up()
	{
		...
		\DB::query('CREATE INDEX season ON games(`season`)')->execute();
		\DB::query('CREATE INDEX game_type_id ON games(`game_type_id`)')->execute();
		\DB::query('CREATE INDEX opponent_id ON games(`opponent_id`)')->execute();
		\DB::query('CREATE INDEX site_id ON games(`site_id`)')->execute();
	}

	public function down()
	{
		\DB::query('DROP INDEX season ON games')->execute();
		\DB::query('DROP INDEX game_type_id ON games')->execute();
		\DB::query('DROP INDEX opponent_id ON games')->execute();
		\DB::query('DROP INDEX site_id ON games')->execute();

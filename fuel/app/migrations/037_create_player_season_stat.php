...
class Create_player_season_stat
{
	public function up()
	{
		\DBUtil::create_table('player_season_stat', array(
		...
		\DB::query('CREATE INDEX person_id ON player_season_stat(`person_id`)')->execute();
		\DB::query('CREATE INDEX season_id ON player_season_stat(`season_id`)')->execute();
	}

	public function down()
	{
		\DB::query('DROP INDEX person_id ON player_season_stat')->execute();
		\DB::query('DROP INDEX season_id ON player_season_stat')->execute();

		\DBUtil::drop_table('player_season_stat');
	}
}
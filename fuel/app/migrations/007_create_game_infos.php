...
class Create_game_infos
{
	public function up()
	{
		\DBUtil::create_table('game_infos', array(
		...
		\DB::query('CREATE INDEX game_id ON game_infos(`game_id`)')->execute();
	}

	public function down()
	{
		\DB::query('DROP INDEX game_id ON game_infos')->execute();

		\DBUtil::drop_table('game_infos');
	}
}
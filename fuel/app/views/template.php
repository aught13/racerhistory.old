    ...
    <body>
        <nav id="topNav" class="w3-top racer-gold">
            <div class="w3-auto w3-bar w3-large">
                <a id="scroll" class="w3-bar-item w3-button w3-hide" href="<?= (($current_user) ? '/admin' : ''); ?>/">
                    <img class=""style="width: 100%; max-width: 540px; height: 100%; max-height: 29px" alt="Racerhistory.com"src="/assets/img/logo.png"></img>
                </a>
            ...
            <div class="w3-auto">
                <div class="w3-left w3-col l10 m12 s12">
                    <?php if (\Session::get_flash('success')): ?>
                        <div id="success" style="display: block;" class="w3-modal">
                    ...
                    <?php if (\Session::get_flash('error')): ?>
                        <div id="alert" style="display: block;" class="w3-modal">
                            <div class="w3-modal-content">
                                <div class="w3-container">

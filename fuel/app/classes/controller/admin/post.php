...
class Controller_Admin_Post extends Controller_Admin 
{
	...
	public function action_create()
	{
            ...
            $fieldset = \Fuel\Core\Fieldset::forge('post')->add_model('Model_post');
            $fieldset->populate('Model_post', true);
	...
	public function action_edit($id = null)
	{
            ...
            // Create the fieldset, add the model, repopulate values if needed
            $fieldset = \Fuel\Core\Fieldset::forge('post')->add_model('Model_post')->populate($post, true);
            // Generate the form
            $form     = $fieldset->form();            
            // Add a submit button

...
namespace Controller\Admin\Player\Season;

class Stat extends \Controller\Admin {

    public function action_index() {
        $query = \Model\Player\Season\Stat::query();
    ...
    public function action_view($id = null) {
        $data['player_season_stat'] = \Model\Player\Season\Stat::find($id);
    ...
    public function action_create() {
        ...
        $this->template->set_global('seasons' , $seasons, false);
        $persons = \Model\Person::menuPersons();
        $this->template->set_global('persons' , $persons, false);
        
        if (\Input::method() == 'POST') {
            $val = \Model\Player\Season\Stat::validate('create');

            if ($val->run()) {
                $player_season_stat = \Model\Player\Season\Stat::forge([
    ...
    public function action_edit($id = null) {
        $player_season_stat = \Model\Player\Season\Stat::find($id);
        $val = \Model\Player\Season\Stat::validate('edit');
    ...
    public function action_delete($id = null) {
        if ($player_season_stat = \Model\Player\Season\Stat::find($id)) {

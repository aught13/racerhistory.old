...
class Team extends \Controller\Admin {
    ...
    public function action_create() {
        ...
        $fieldset = \Fuel\Core\Fieldset::forge('team')->add_model('Model\team');
        $fieldset->populate('Model\team', true);
